...
##### Load FB IVS Data #####
y = np.load('./fb/20210212_ivs.npy').ravel()
print("no. of market observations = %d" % (np.sum(y > 0)))

##### Rate Setting #####
risk_free_rate = 0.012  ## US10Y close 1.2@20210212 1.345@20210219  1.407@20210226
dividend_rate = 0.0  ## Current dividend yield
...
##### Create Vol Surface #####
calculation_date = ql.Date(12, 2, 2021)
...
##### Set Base Condition #####
spot_price = 270.50  ## FB close 270.50@20210212 261.56@20210219  257.62@20210226
