...
### Stock: AAPL
### Model: params-IVS and traditional QL helper
###
############################################################
...
##### Load AAPL IVS Data #####
y = np.load('./aapl/20210219_ivs.npy').ravel()
print("no. of market observations = %d" % (np.sum(y > 0)))

##### Rate Setting #####
risk_free_rate = 0.01345  ## US10Y close 1.2@20210212 1.345@20210219  1.407@20210226
dividend_rate = 0.82 / 129.87
...
def cost_fun_nn(y, rates):
    def cost_fun(params):
        ...
        diff = (pred - y) * (y > 0)
        return np.sum(abs(diff)/(y+0.00000001))
    return cost_fun
...
calculation_date = ql.Date(19, 2, 2021)
ql.Settings.instance().evaluationDate = calculation_date

##### Set Base Condition #####
spot_price = 129.87   ## AAPL close 135.37@20210212 129.87@20210219  121.26@20210226
